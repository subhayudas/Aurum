...
function Facilities({}: Props) {
  ...
  const texts = [
    "Aurum Resort offers you a wide range of",
    "luxury amenities and experiences. Enjoy our",
    "spa, play at our sports facilities including",
    "pickleball, tennis, golf, and cricket, or explore",
    "the nearby bird sanctuary and Japanese garden.",
  ];
    ...
    <div className="bg-off-white w-[100%] border-2 border-transparent border-solid ">
      <div className="mt-[100px] ">
        ...
        <div className="flex  items-end  mx-auto gap-[70px] w-[95%] mt-[40px] max-[600px]:flex-col  max-[600px]:gap-[50px]">
          ...
          {/* <p >
            Aurum offers you a wide range of additional services and
          ...
          >
            ...
            >
              {" "}
              Aurum offers you a wide range of{" "}
            </motion.li>
          ...
          {/* <SplitText
            text=" Aurum offers you a wide range of additional services and
            facilities. Visit our restaurant to try exclusive meals, book a
            conference hall to organize a business meeting, or relax in the
              art-bar."
