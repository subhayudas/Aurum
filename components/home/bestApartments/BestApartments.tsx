    ...
    <div className="">
      <div className="h-[90vh]">
        <div ref={ref} className="h-[100%] w-full relative ">
          ...
          />
          <p className="absolute min-[500px]:top-1/2 min-[500px]:left-[30px] transform -translate-y-1/2  max-[500px]:bottom-[10px]  max-[500px]:right-[10px] text-golden_yellow font-helvetica text-[20px] w-[350px] ">
            ...
            with sustainable materials and modern amenities.
          </p>
        </div>
      </div>
    </div>
